...
- PyQt6 - настольное приложение. для соединения с сервером
используются следующие компоненты:
  - websocket-client для установки websocket соединения с сервером
  - requests - для первичного запроса данных о VPS
